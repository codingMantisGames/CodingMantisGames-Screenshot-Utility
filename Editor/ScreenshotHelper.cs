...
namespace NehalVXavier.Tools
{
    public class ScreenshotHelper : EditorWindow
    {
        ...
        [MenuItem("Coding Mantis Games/Screenshot Utility")]
        public static void ShowWindow()
        {
            var window = GetWindow<ScreenshotHelper>("Screenshot Helper");
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label("Coding Mantis Games Screenshot Utility", headerStyle);
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            if (GUILayout.Button("Coding Mantis Games", GUILayout.Width(150)))
            {
                Application.OpenURL("https://linktr.ee/codingmantisgames");
            }
            GUILayout.FlexibleSpace();
            ...
            for (int i = 0; i < resolutionSettings.resolutionNames.Count; i++)
            {
                ...
                EditorGUI.BeginDisabledGroup(!Application.isPlaying || isTakingScreenshot);
            ...
            GUILayout.EndHorizontal();
            EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
            useTimer = EditorGUILayout.Toggle("Use Timer", useTimer);
            EditorGUI.BeginDisabledGroup(!useTimer);
        ...
        public void TakeScreenshot(int x, int y, string path, string fileName, int count, int c)
        {
            ...
            if (index != -1)
            {
                ...
                UnityEngine.Debug.Log("Screenshot Saved : " + finalPath);
